...
Here mask refers to a binary mask corresponding to the annotation. Block diagram of the network is shown in ![Figure 1]. (https://github.com/mravendi/AIclub/blob/master/figs/gan1.png)
